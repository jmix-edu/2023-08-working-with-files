...
public class TaskEdit extends StandardEditor<Task> {
    ...
    public void onImportSubtasksFieldFileUploadSucceed(final SingleFileUploadField.FileUploadSucceedEvent event) throws IOException {
    ...
    private void processFile(File file) throws IOException {
        ...
        for (String line : lines) {
            Subtask subtask = dataManager.create(Subtask.class);
